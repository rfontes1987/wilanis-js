...
| [0023](0023-adapters.md) | Adapters: search, email, payment | draft |
...
| [0030](0030-cache.md) | `cache`: one word on a node, a graph or an operation, lowered to the nodes it stands for | draft |
