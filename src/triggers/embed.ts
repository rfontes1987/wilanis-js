 ...
 */
import { Compiler, buildEnv, runGraph, type CompileOptions, type Compiled } from '../compiler/compiler.js';
import type { Report } from '../kernel/spec.js';
import type { TriggerDoc } from '../model.js';
import type { PluginModule, Codecs } from '../plugins/plugin.js';
import type { Scope } from '../check/scope.js';
import { conforms, type Type } from '../types/type.js';
import { TEMPLATE, WHOLE_TEMPLATE } from '../check/scope.js';
