/**
 * @http: outbound requests (http.port.json#request), http connections, http triggers, body codecs.
...
import { schemaRef, type AnyDoc, type ConnectionKindDoc, type PluginDoc, type PortDoc, type TriggerDoc, type TriggerKindDoc } from '../../model.js';
import type { PluginModule, TriggerRuntime, Codecs } from '../plugin.js';
import type { Report } from '../../kernel/spec.js';
import type { Type } from '../../types/type.js';
import { readPath } from '../../kernel/kernel.js';
import type { PluginCheckContext } from '../../check/checker.js';
...
export const http: PluginModule & { check: typeof check } = {
  root: ROOT,
  docs: {
